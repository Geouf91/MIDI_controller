...
constructor(t){(0,e.setOwner)(this,t),window.addEventListener("click",this.showDatePopover,{passive:!0}),this.siteSettings.discourse_local_dates_enabled&&(0,r.withPluginApi)(T)}showDatePopover(t){if(t?.target?.classList?.contains("download-calendar")){const e=t.target.dataset
...
//# sourceMappingURL=discourse-local-dates-4ed2188e.map