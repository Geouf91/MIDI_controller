...
e.stack=[],e.openNode(e.schema.nodes.footnote),e.parseTokens(l)
const c=e.closeNode()
e.stack=[r]
const d=new t(o.from(c),0,0)
...
e.write(`[^${o+1}]: `),e.delim+="    ",e.renderContent(t[o]),e.delim=n}}},inputRules(e){let{pmState:{NodeSelection:t}}=e
return[{match:/\^\[(.*?)]$/,handler:(e,t,o,n)=>{const i=e.doc.slice(o+2,n).content,s=e.schema.nodes.paragraph.create(null,i),r=e.schema.nodes.footnote.create(null,s)
return e.tr.replaceWith(o,n,r)}},{match:/\[\^\d+]$/,handler:(e,o,n,i)=>{const s=e.schema.nodes.paragraph.create(),r=e.schema.nodes.footnote.create(null,s),a=e.tr.replaceWith(n,i,r)
return a.setSelection(t.create(a.doc,n)),a}}]}}
e.default=t})

//# sourceMappingURL=footnote-cf85c437.map